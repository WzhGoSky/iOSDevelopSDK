...
@implementation SignatureBoardView
/**
 *  重写初始化方法
 */
...
- (void)clean {
    ...
    self.currentWidth = 8.0;
}

/**
 *  更新UI
 */
- (void)updateUIWithImg:(UIImage *)img {
