...
/**
 裁剪按钮代理事件
 */
@protocol DoodleClipViewDelegate <NSObject>
- (void)ImageViewFinish:(UIImage *)cropImage; //完成裁剪
- (void)ImageViewFinish:(UIImage *)cropImage frame:(CGRect)frame; //完成裁剪
- (void)ImageViewCancel;      //取消裁剪
@end

@interface DoodleClipView : UIView
...
/* ----------------- 代理事件--------------------------- */
//裁剪按钮delegate
@property (nonatomic, assign)id<DoodleClipViewDelegate>delegate;
