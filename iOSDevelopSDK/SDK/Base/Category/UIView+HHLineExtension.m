...
- (UIView *)borderForColor:(UIColor *)color borderWidth:(CGFloat)borderWidth borderType:(HHBorderSideType)borderType {
    ...
    /// 左侧
    if (borderType & HHBorderSideTypeLeft) {
        /// 左侧线路径
    ...
    /// 右侧
    if (borderType & HHBorderSideTypeRight) {
        /// 右侧线路径
    ...
    /// top
    if (borderType & HHBorderSideTypeTop) {
        /// top线路径
    ...
    /// bottom
    if (borderType & HHBorderSideTypeBottom) {
        /// bottom线路径
